 ...
 *
 */
public class MongoNameModelDAO extends AbstractClassDAO implements NameModelDAOInterface {

	/**
	 * 
	 */
	public MongoNameModelDAO() {
		super("avellNew", "namesModels");
	}
...
//		int tempCont = 0;
		...
		while (cursor.hasNext()) {
			...
			results.add(item.getString("nameModel"));
