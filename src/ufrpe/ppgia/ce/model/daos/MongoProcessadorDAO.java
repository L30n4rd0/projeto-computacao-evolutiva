 ...
 *
 */
public class MongoProcessadorDAO extends AbstractClassDAO implements ProcessorDAOInterface {

	/**
	 * 
	 */
	public MongoProcessadorDAO() {
		super("avellNew", "processors");
	}
	 ...
	 */
	@Override
	public void insert(Processor s) throws Exception {
	 ...
	 */
	@Override
	public void alter(Processor s) throws Exception {
		// TODO Auto-generated method stub
	 ...
	 */
	@Override
	public Processor getByStringData(String data) throws Exception {
		// TODO Auto-generated method stub
		return null;
	}
	...
	public List<Processor> getAll() throws Exception {
		List<Processor> results = new ArrayList<>();
...
//		int tempCont = 0;
		...
		while (cursor.hasNext()) {
			...
			Processor result = gson.fromJson(item.toJson(), Processor.class);
