 ...
 *
 */
public class MongoStorageMemoryDAO extends AbstractClassDAO implements StorageMemoryDAOInterface {

	/**
	 * 
	 */
	public MongoStorageMemoryDAO() {
		super("avellNew", "storageMemories");
	}
